...
tonkean = etho.Focals('../Data/Etho/Raw/Tonkean_2021',
...
for i in list(grooming.index):
    row = grooming.loc[i]
    if row.Behavior == '2 Zone de Grooming' or row.Behavior == '4 Fin Grooming':
        print(i)
        print(" , " + row.Modifiers.split("Groom.er.ee ")[1])
