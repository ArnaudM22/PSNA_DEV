...
def undir_adj_table(data, directed_behaviors, undirected_behaviors, behaviors, indiv_list):
    ...
    undir_adj = adj_table(data, directed_behaviors, undirected_behaviors, behaviors, indiv_list)
    for i in directed_behaviors:
        undir_adj.loc[i] = (
            undir_adj.loc[i].transpose() + undir_adj.loc[i]).values
    return undir_adj

def table_list(table, behaviors, dyad_obs):
