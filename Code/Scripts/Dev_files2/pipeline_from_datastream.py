...
# we should remove from list the agonistic interaction.
agonistic_interaction = agonistic_interaction
affiliative_interactions = ['Huddling', 'Proximity']
directed_interaction = affiliative_interactions
